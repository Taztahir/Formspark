...
const TypewriterCode = () => {
  const lines = [
    ...
    { text: '  action="https://api.formspark.io/login"', color: 'text-white' },
    ...
    { text: '  <button type="submit">Login</button>', color: 'text-white' },
    { text: '</form>', color: 'text-brand-primary' }
  ];
...
const Login = () => {
  ...
  return (
    <motion.div
      ...
      className="h-screen w-full flex bg-brand-bg font-sans overflow-hidden"
    >

      {/* LEFT SIDE - Form */}
      <div className="w-full lg:w-[45%] h-full flex flex-col relative bg-brand-bg border-r border-brand-text overflow-y-auto">
          ...
          <div className="w-full max-w-[320px]">
            ...
            >
              <div className="inline-flex items-center gap-2 border border-brand-primary px-3 py-1 mb-6 bg-transparent">
                ...
                <span className="text-[9px] font-bold text-brand-primary tracking-widest uppercase">Login to Your Account</span>
              </div>
              ...
              <p className="mt-4 text-[11px] font-semibold text-brand-text/80 leading-relaxed">
                Log in to your Formspark account to manage forms, view submissions, and connect your favorite tools.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-center justify-between pt-1 pb-2">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-3.5 h-3.5 rounded-sm border-brand-text/40 text-brand-primary focus:ring-brand-primary bg-transparent accent-brand-primary" />
                  <span className="text-[10px] font-bold text-brand-text">Remember me</span>
                </label>
              ...
              <div className="py-3 flex items-center justify-center gap-4">
                ...
                <span className="text-[9px] font-bold text-brand-text/50 uppercase tracking-widest">Or continue with</span>
                <div className="h-px bg-brand-text/20 flex-1"></div>
              </div>
            ...
            >
              <p className="text-xs font-bold text-brand-text">
                Don't have an account? <Link to="/signup" className="text-brand-primary hover:underline ml-1">Create one <span className="inline-block ml-1">&rarr;</span></Link>
              </p>
            </motion.div>
          </div>
      ...
      <div className="hidden lg:flex w-[55%] h-full bg-[#111111] relative overflow-hidden flex-col justify-center pl-16">
        ...
        >
          <span className="text-brand-primary font-mono font-bold text-sm tracking-widest">{">"} AUTH_LOGIN</span>
        </motion.div>
